...
var teleports = require("../../assets/maps/content/teleports.json");
var Settings = (function () {
    function Settings() {
        ...
        this.allTeleports = _(teleports)
            .values()
            .map(function (entry) { return _.map(entry, function (loc, key) {
            loc.name = key;
            return loc;
        }); })
            .flattenDeep()
    ...
    Settings.prototype.locToTeleport = function (name) {
        return _.find(this.allTeleports, { name: name });
    };
    return Settings;
}());
