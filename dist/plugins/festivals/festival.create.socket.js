...
exports.socket = function (socket, primus, respond) {
    var createfestival = function (_a) {
        var targetFestivalString = _a.targetFestivalString;
        return __awaiter(_this, void 0, void 0, function () {
            var playerName, player, festival, bonuses, realFestival;
            return __generator(this, function (_a) {
                ...
                if (!player || !player.isMod)
                    return [2 /*return*/];
                festival = asset_loader_1.JSONParser.parseFestivalString(targetFestivalString);
                if (!festival || !festival.hours || !festival.name) {
                    return [2 /*return*/, respond({ type: 'error', notify: 'Invalid festival.' })];
                }
                logger_1.Logger.info('Socket:GM:CreateFestival', playerName + " (" + socket.address.ip + ") creating festival \"" + targetFestivalString + "\".");
                bonuses = _.omit(festival, ['hours', 'name']);
                realFestival = {
