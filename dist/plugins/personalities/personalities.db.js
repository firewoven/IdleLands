...
var personalities_1 = require("./personalities");
var PersonalitiesDb = (function () {
    function PersonalitiesDb(DbWrapper) {
        this.dbWrapper = DbWrapper;
    }
    PersonalitiesDb.prototype.getPersonalities = function (id) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                personalities.find({ _id: id }).limit(1).next(function (err, doc) {
                                    ...
                                    try {
                                        var personalities_2 = di_wrapper_1.constitute(personalities_1.Personalities);
                                        personalities_2.init(doc);
                                        resolve(personalities_2);
                                    }
                                    catch (e) {
    ...
    PersonalitiesDb.prototype.savePersonalities = function (personalitiesObject) {
        return __awaiter(this, void 0, void 0, function () {
            var db, personalities;
            return __generator(this, function (_a) {
                switch (_a.label) {
