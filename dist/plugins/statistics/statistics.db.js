...
var StatisticsDb = (function () {
    function StatisticsDb(DbWrapper) {
        this.dbWrapper = DbWrapper;
    }
    StatisticsDb.prototype.getStatistics = function (id) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                statistics.find({ _id: id }).limit(1).next(function (err, doc) {
                                    ...
                                    try {
                                        var statistics_2 = di_wrapper_1.constitute(statistics_1.Statistics);
                                        statistics_2.init(doc);
                                        resolve(statistics_2);
                                    }
                                    catch (e) {
    ...
    StatisticsDb.prototype.saveStatistics = function (statsObject) {
        return __awaiter(this, void 0, void 0, function () {
            var db, statistics;
            return __generator(this, function (_a) {
                switch (_a.label) {
