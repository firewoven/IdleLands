...
var AchievementsDb = (function () {
    function AchievementsDb(DbWrapper) {
        this.dbWrapper = DbWrapper;
    }
    AchievementsDb.prototype.getAchievements = function (id) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                achievements.find({ _id: id }).limit(1).next(function (err, doc) {
                                    ...
                                    try {
                                        var achievements_2 = di_wrapper_1.constitute(achievements_1.Achievements);
                                        achievements_2.init(doc);
                                        resolve(achievements_2);
                                    }
                                    catch (e) {
    ...
    AchievementsDb.prototype.saveAchievements = function (achievementsObject) {
        return __awaiter(this, void 0, void 0, function () {
            var db, achievements;
            return __generator(this, function (_a) {
                switch (_a.label) {
