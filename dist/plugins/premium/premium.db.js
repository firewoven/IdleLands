...
var PremiumDb = (function () {
    function PremiumDb(DbWrapper) {
        this.dbWrapper = DbWrapper;
    }
    PremiumDb.prototype.getPremium = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        db = _a.sent();
                        premiums = db.$$collections.premiums;
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                premiums.find({ _id: id }).limit(1).next(function (err, doc) {
                                    if (err) {
                                        return reject({ err: err, msg: messages_1.MESSAGES.GENERIC });
                                    }
                                    try {
                                        var premium = di_wrapper_1.constitute(premium_1.Premium);
                                        premium.init(doc);
                                        resolve(premium);
                                    }
                                    catch (e) {
    ...
    PremiumDb.prototype.savePremium = function (premiumObject) {
        return __awaiter(this, void 0, void 0, function () {
            var db, premiums;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        premiums = db.$$collections.premiums;
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                premiums.findOneAndUpdate({ _id: premiumObject._id }, { $set: {
