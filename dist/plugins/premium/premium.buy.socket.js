...
exports.socket = function (socket, primus, respond) {
    var buyilp = function (_a) {
        var itemName = _a.itemName;
        return __awaiter(_this, void 0, void 0, function () {
            var playerName, player, item, errMsg;
            return __generator(this, function (_a) {
                ...
                item = _.find(player.$premium.buyable, { name: itemName });
                if (!item) {
                    return [2 /*return*/, respond({ type: 'error', title: 'ILP Buy Error', notify: 'That item does not exist.' })];
                }
                errMsg = player.$premium.cantBuy(player, item);
                if (errMsg) {
                    return [2 /*return*/, respond({ type: 'error', title: 'ILP Buy Error', notify: errMsg })];
                }
