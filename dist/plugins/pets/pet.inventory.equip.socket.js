...
exports.event = 'plugin:pet:equip';
exports.description = 'Equip an item from your pets inventory.';
exports.args = 'itemId';
exports.socket = function (socket, primus, respond) {
    var petequip = function (_a) {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!player)
                    return [2 /*return*/];
                logger_1.Logger.info('Socket:Pet:Equip', playerName + " (" + socket.address.ip + ") pet equipping " + itemId + ".");
    ...
    socket.on(exports.event, petequip);
};
