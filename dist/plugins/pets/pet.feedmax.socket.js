...
exports.event = 'plugin:pet:feedmax';
exports.description = 'Feed your pet maximum gold.';
exports.args = '';
exports.socket = function (socket, primus, respond) {
    var feed = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (!player)
                return [2 /*return*/];
            logger_1.Logger.info('Socket:Pet:FeedMax', playerName + " (" + socket.address.ip + ") feeding pet MAX.");
            message = player.$pets.feedMax(player);
            if (message) {
