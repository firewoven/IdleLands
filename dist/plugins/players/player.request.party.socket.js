...
exports.event = 'plugin:player:request:party';
exports.description = 'Request party data. Generally used only when looking at overview.';
exports.args = '';
exports.socket = function (socket) {
    var requestparty = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    socket.on(exports.event, requestparty);
};
