...
exports.event = 'plugin:player:request:collectibles';
exports.description = 'Request collectible data. Generally used only when looking at collectibles.';
exports.args = '';
exports.socket = function (socket) {
    var requestcollectibles = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    socket.on(exports.event, requestcollectibles);
};
