...
exports.event = 'plugin:player:request:pets';
exports.description = 'Request pet data.';
exports.args = '';
exports.socket = function (socket) {
    var requestpet = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    socket.on(exports.event, requestpet);
};
