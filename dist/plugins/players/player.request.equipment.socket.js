...
exports.event = 'plugin:player:request:equipment';
exports.description = 'Request equipment data. Generally used only when looking at equipment.';
exports.args = '';
exports.socket = function (socket) {
    var requestequipment = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    socket.on(exports.event, requestequipment);
};
