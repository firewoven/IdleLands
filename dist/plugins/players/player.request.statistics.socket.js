...
exports.event = 'plugin:player:request:statistics';
exports.description = 'Request statistics data. Generally used only when looking at statistics.';
exports.args = '';
exports.socket = function (socket) {
    var requeststatistics = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    socket.on(exports.event, requeststatistics);
};
